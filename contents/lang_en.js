export default {
  ...
  ipConnectivity: {
    ...
    Note: "Test IP only by visiting https port of each ip address to check if ip is accessible.",
    StatusWait: "Awaiting Test",
    StatusAvailable: "OK",
    StatusUnavailable: "Unavailable",
    StatusTimeout: "Timeout or Unavailable",
  ...
  adblock: {
    id: "adblock",
    Title: "Adblock",
    Note: "Test adblocks by visiting each adblock url.",
    StatusWait: "Awaiting Test",
    StatusAvailable: "OK",
    StatusUnavailable: "Unavailable",
    StatusTimeout: "Timeout or Unavailable",
  ...
  security: {
    ...
    Note: "Test active protect by visiting each url, content from these URLs are directly discarded.",
    StatusWait: "Awaiting Test",
    StatusAvailable: "OK",
    StatusUnavailable: "Unavailable",
    StatusTimeout: "Timeout or Unavailable",
  ...
  porn: {
    id: "porn",
    Title: "Porn",
    Note: "Test Porn by visiting each url, content from these URLs are directly discarded.",
    StatusWait: "Awaiting Test",
    StatusAvailable: "OK",
    StatusUnavailable: "Unavailable",
    StatusTimeout: "Timeout or Unavailable",
